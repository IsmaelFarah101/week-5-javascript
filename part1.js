...
rates.CHF = 1.1787
let euros = 100
let conversion = euros/rates.CHF
console.log(`${euros} euros is equivalent to ${conversion}`)
let max = rates.AUD;
for( obj in rates){
    if(rates[obj] > max){
        max = rates[obj]    
...
console.log(`${max} is the highest value in rates`);
...
let lat = iss_location.iss_position.latitude;
let lon = iss_location.iss_position.longitude;
...
console.log(`${garyscat} is Gary Oldmans cat`)
let taylorscat = cats_and_owners.push({name: "Taylor Swift", cat: "Meredith"})
...
console.log("-----------------------Literature Laureate-------------------------------")
nobel_prize_winners_2017.prizes.forEach(function(element){
    if(element.category ==  "literature"){
        element.laureates.forEach(function(element){
            console.log(`${element.firstname} ${element.surname}`)
        })
                
    }
})

console.log("-----------------------Physics Laureate ID--------------------------------")
nobel_prize_winners_2017.prizes.forEach(function(element){
...
console.log("-----------------------NUmber of Prize Categories---------------------------")
console.log(categorycounter)
console.log("-----------------------NUmber of Nobel Prize Laureates----------------------")
let lauretecounter = 0
nobel_prize_winners_2017.prizes.forEach(function(element){
    element.laureates.forEach(function(element){
        lauretecounter++
    })
})
console.log(lauretecounter)
